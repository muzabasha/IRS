    ...
    return (
        <div className="space-y-8">
            ...
            <Card className="border-none shadow-lg bg-gradient-to-br from-orange/5 to-background">
                <CardHeader>
                    <CardTitle>Complete Multimedia & Web Comparison</CardTitle>
                    <CardDescription>
                        See all multimedia and web search techniques side-by-side
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="bg-gradient-to-r from-primary/10 to-purple/10 p-6 rounded-lg border-2 border-primary/20">
                        <h3 className="font-bold text-lg mb-2 flex items-center gap-2">
                            ...
                            Unit 4 Complete Comparison Journey
                        </h3>
                        <p className="text-sm text-muted-foreground mb-4">
                            Compare multimedia IR, web crawling, PageRank, and meta-search techniques.
                            See color-based image retrieval, BFS crawling, PageRank convergence, and result aggregation.
                        </p>
